package draw; /******************************************************************************
 *  Compilation:  javac draw.Draw.java
 *  Execution:    java draw.Draw
 *  Dependencies: none
 *
...
/**
 * <i>draw.Draw</i>. This class provides a basic capability for
...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     *
     * @param listener the {\tt draw.DrawListener} argument
     */
