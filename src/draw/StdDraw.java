package draw; /******************************************************************************
 *  Compilation:  javac draw.StdDraw.java
 *  Execution:    java draw.StdDraw
 *  Dependencies: none
 *
...
/**
 * The {@code draw.StdDraw} class provides a basic capability for
 * creating drawings with your programs. It uses a simple graphics model that
 ...
 * <p>
 * <b>Getting started.</b>
 * To use standard drawing, you must have {@code draw.StdDraw.class} in your
 * Java classpath. If you used our autoinstaller, you should be all set.
 * Otherwise, download
 * <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">draw.StdDraw.java</a>
 ...
 *           draw.StdDraw.setPenRadius(0.05);
 *           draw.StdDraw.setPenColor(draw.StdDraw.BLUE);
 *           draw.StdDraw.point(0.5, 0.5);
 *           draw.StdDraw.setPenColor(draw.StdDraw.MAGENTA);
 *           draw.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 * The methods {@code draw.StdDraw.line()} and {@code draw.StdDraw.point()}
 * draw lines and points; the methods {@code draw.StdDraw.setPenRadius()}
 * and {@code draw.StdDraw.setPenColor()} control the line thickness and color.
 * p>
 ...
 * and represented in degrees. For example, {@code draw.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  draw.StdDraw.filledPolygon(x, y);
 * </pre>
 * p>
 * <b>Pen size.</b>
 ...
 * </ul>
 * p>
 * For example, {@code draw.StdDraw.setPenRadius(0.025)} makes
 ...
 * For example, {@code draw.StdDraw.setPenColor(draw.StdDraw.MAGENTA)} sets the
 ...
 * For example, {@code draw.StdDraw.setCanvasSize(800, 800)}
 ...
 * leave a small margin, you can call {@code draw.StdDraw.setScale(-.05, 1.05)}.
 * p>
 ...
 *  draw.StdDraw.setFont(font);
 *  draw.StdDraw.text(0.5, 0.5, "Hello, World");
 * </pre>
 * p>
 * <b>Images.</b>
 ...
 * {@code draw.StdDraw.clear(draw.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 * of gray.
 * p>
 ...
 * <li> draw.Draw objects on the offscreen canvas.
 ...
 * <pre>
 *  draw.StdDraw.setScale(-2, +2);
 *  draw.StdDraw.enableDoubleBuffering();
 *
 *  for (double t = 0.0; true; t += 0.02) {
 *      double x = Math.sin(t);
 *      double y = Math.cos(t);
 *      draw.StdDraw.clear();
 *      draw.StdDraw.filledCircle(x, y, 0.05);
 *      draw.StdDraw.filledCircle(-x, -y, 0.05);
 *      draw.StdDraw.show();
 *      draw.StdDraw.pause(20);
 *  }
 * </pre>
 * p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static void init() {
        ...
        frame.setTitle("Standard draw.Draw");
     ...
     * {@code draw.StdDraw.BLACK}, {@code draw.StdDraw.BLUE}, {@code draw.StdDraw.CYAN},
     * {@code draw.StdDraw.DARK_GRAY}, {@code draw.StdDraw.GRAY}, {@code draw.StdDraw.GREEN},
     * {@code draw.StdDraw.LIGHT_GRAY}, {@code draw.StdDraw.MAGENTA}, {@code draw.StdDraw.ORANGE},
     * {@code draw.StdDraw.PINK}, {@code draw.StdDraw.RED}, {@code draw.StdDraw.WHITE}, and
     * {@code draw.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to draw.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to draw.StdDraw)
        try {
            URL url = draw.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
